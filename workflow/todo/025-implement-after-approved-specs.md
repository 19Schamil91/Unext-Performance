...
- Keine Umsetzung startet ohne freigegebene Specs.
- Keine Umsetzung startet ohne freigegebenen Rework-Plan.
- Umsetzungstasks sind konkret, begrenzt und pruefbar.
- Mobile First ist in relevanten Umsetzungstasks enthalten.
- Supabase, KI, Dependencies, Environment-Variablen und Routen-Aenderungen werden nur nach ausdruecklicher Freigabe umgesetzt.
